<%-- 
    Document   : cena
    Created on : 28/06/2019, 07:02:56 PM
    Author     : 52449
--%>
...
<% 
    //Conexcion a la base de datos
        ...
        ResultSet rs;
      ps=conexion.prepareStatement("SELECT id,nombre_platillo as np,ingredientes,tiempo_preparacion,instrucciones,calorias,estatus,imagen FROM software_nutricion.\"Recetas\" WHERE estatus = 'cena'"); 
    ...
    <center>
        <div class="addthis_toolbox addthis_32x32_style addthis_default_style"><b><h1>CENA</h1></b></div>
  ...
  <a href="eliminar_receta.jsp?id=<%=rs.getInt("id") %>" ><img src="boton-x.png"></a>            
          ...
          <a href="Editar_cena.jsp?np=<%=rs.getString("np")%>"><img src="editar2.png"></a>
