...
<% 
 ...
 System.err.println(ps);
    ...
    %>
        ...
        <center>
<form action="Leido_Paciente_E" method="POST" class="form_contact">
    ...
    <table   class="table table-hover">
                            <th style="background-color:#A4A4A4"> CONTACTO  <input type="text" name="id" readonly="" value = "<%=rs.getInt("id")%>" size="1" required>
 </th>
...
%>
 <input type="text" name="fecha" readonly="" value = "<%=rs.getString("fecha")%>" size="12" required>
                ...
                <tr>
                    <th >Tu Usuario : </th>
                    <th><input type="text" name="user_name_envia" readonly="" value = "<%=rs.getString("user_name_recibe")%>" size="40" required></th>
                </tr>
                <tr>
                    <th>Para :</th>
                       <th><input type="text" name="user_name_recibe" readonly="" value = "<%=rs.getString("user")%>" size="" required></th>
