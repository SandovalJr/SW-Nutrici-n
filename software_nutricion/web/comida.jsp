<%-- 
    Document   : comida
    Created on : 28/06/2019, 07:01:58 PM
    Author     : 52449
--%>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
   ...
   <title>COMIDA RECETAS</title> <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
</head>
...
<% 
    //Conexcion a la base de datos
        ...
        ResultSet rs;
      ps=conexion.prepareStatement("SELECT id,nombre_platillo as np,ingredientes,tiempo_preparacion,instrucciones,calorias,estatus FROM software_nutricion.\"Recetas\" WHERE estatus = 'comida'"); 
    ...
    <center>
        <div class="addthis_toolbox addthis_32x32_style addthis_default_style"><b><h1>COMIDAS</h1></b></div>
        <br> 
  ...
  <td>
                           ...
                           <a href="Editar_comida.jsp?np=<%=rs.getString("np") %>" ><img src="editar2.png"></a>
