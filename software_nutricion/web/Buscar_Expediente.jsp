...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
   ...
   <title>CSS MenuMaker</title> <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
      ...
      <div style="position: fixed; left: 80%"><img src="software_nutricion/Login_v5/images/icons/logo_nutricion.png" width="300" height="300" alt=""/></div>
...
<% 
    ...
    <div class="container tabla">
        <div style="position: absolute; left: 3%">
                <div class="addthis_toolbox addthis_32x32_style addthis_default_style"><b><h1>EXPEDIENTES</h1></b></div>
        ...
        <thead >
         <tr>
               <th style="background-color:#FFFF00">nombre_apellido</th>
                 ...
                 <th style="background-color:#FFFF00">motivo de consulta</th>
  ...
  <th style="background-color:#FFFF00">user_name</th>
                 <th style="background-color:#FFFF00">password</th>
                    ...
                    <tr>
                        ...
                        <th class="text-center"><%=d.getString("nombrep")%></th>
                        <th class="text-center"><%=d.getString("edad")%></th>
                         <th class="text-center"><%=d.getString("escolaridad")%></th>
                        <th class="text-center"><%=d.getString("civil")%></th>
                          <th class="text-center"><%=d.getString("ocupacion")%></th>
                        <th class="text-center"><%=d.getString("motivo_consulta")%></th>
                                     <th class="text-center"><%=d.getString("antecedentes_heredados")%></th>
                                      <th class="text-center"><%=d.getString("medicamentos")%></th>
                                       <th class="text-center"><%=d.getString("tabaco")%></th>
                                       <th class="text-center"><%=d.getString("alcohol")%></th>
                        <th class="text-center"><%=d.getString("drogas")%></th>
                                      <th class="text-center"><%=d.getString("enfermedadesapp")%></th>
                                      
                                       <th class="text-center"><%=d.getString("alergias_alimentariosapp")%></th>
                        <th class="text-center"><%=d.getString("alimentos_desagradablesapp")%></th>
                           <th class="text-center"><%=d.getString("user_name")%></th>
                        <th class="text-center"><%=d.getString("password")%></th>
                          <th class="text-center"><%=d.getInt("id")%></th>
                                                 
  <th>
                              <a href="eliminar.jsp?id=<%=d.getInt("id")%>"><img src="boton-x.png"></a>
    <a href="editar_exp.jsp?nombrep=<%=d.getString("nombrep")%>"><img src="editar2.png"></a>
        <a href="ver_expediente.jsp?nombrep=<%=d.getString("nombrep")%>"><img src="ojo.png"></a>
