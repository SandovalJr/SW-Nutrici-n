<%-- 
    Document   : colaciones
    Created on : 28/06/2019, 07:04:05 PM
    Author     : 52449
--%>
...
<% 
    //Conexcion a la base de datos
        ...
        ResultSet rs;
      ps=conexion.prepareStatement("SELECT id,nombre_platillo as np,ingredientes,tiempo_preparacion,instrucciones,calorias,estatus,imagen FROM software_nutricion.\"Recetas\" WHERE estatus = 'colacion'"); 
    ...
    <center>
        <div class="addthis_toolbox addthis_32x32_style addthis_default_style"><b><h1>COLACIONES</h1></b></div>
  ...
  <a href="eliminar_receta.jsp?id=<%=rs.getInt("id") %>"> <img src="boton-x.png"></a>      
            <a href="Editar_colaciones_1.jsp?np=<%=rs.getString("np")%>"><img src="editar2.png"></a>
