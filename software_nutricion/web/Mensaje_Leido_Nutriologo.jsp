...
<ul>
  ...
  PreparedStatement ps;
   ...
   System.out.println(user);
    ps=conexion.prepareStatement("SELECT id,user_name_envia as user,user_name_recibe,asunto,mensaje,estatus,fecha  FROM software_nutricion.\"Mensajes\" WHERE id="+id); 
 rs=ps.executeQuery();  
 System.err.println(ps);
    ...
    %>
        ...
        <br><br>
        <center>
<form action="update_nutriologo_leido" method="POST" class="form_contact">
    ...
    <table   class="table table-hover">
                            <th style="background-color:#A4A4A4"> CONTACTO  <input type="text" name="id" readonly="" value = "<%=rs.getInt("id")%>" size="12" required>
 </th>
...
%>
 <input type="text" name="fecha" readonly="" value = "<%=rs.getString("fecha")%>" size="12" required>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Asunto:</td>
                        <td> <input type="text" name="asunto"  readonly="" value = "<%=rs.getString("asunto")%>" size="40" required></td>
                        
                    </tr>
                    <tr>
                        <td>Mensaje:  </td>
                        <th>  <textarea style="font-size:15px"  readonly="" rows="8" cols="80" type="text"  name="mensaje"required ><%=rs.getString("mensaje")%></textarea></th>
