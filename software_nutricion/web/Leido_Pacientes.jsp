...
var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
    ...
    dieta=conexion.prepareStatement("SELECT id,user_name_envia,user_name_recibe,asunto,mensaje,estatus,fecha  FROM software_nutricion.\"Mensajes\" WHERE estatus ='Leido' and user_name_envia='"+user_name+"'"); 
