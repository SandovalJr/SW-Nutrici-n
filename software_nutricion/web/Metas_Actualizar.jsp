    ...
    <table   class="table table-hover">
        ...
        <td> <input  type="text" name="user_name"  readonly="" value = "<%= user%>" size="40" ></td>
                ...
                <tbody>
                    ...
                    <th><input type="text" name="meta1" value = "<%=rs.getString("meta1")%>" size="40" required></th>
                     ...
                     <th style="background-color:#A4A4A4">Objetivo 2 </th>
                                 <th><input type="text" name="meta2" value = "<%=rs.getString("meta2")%>" size="40" required></th>

        </tr>
        <tr>
            <td>Descripcion 1:</td>
            <th>  <textarea style="font-size:15px" rows="5" cols="43" type="text"  name="descripcion1"required ><%=rs.getString("descripcion1")%></textarea></th>
                    ...
                    <td></td>
                         <td>Descripcion 2:</td>
            <th>  <textarea style="font-size:15px" rows="5" cols="43" type="text"  name="descripcion2"required ><%=rs.getString("descripcion2")%></textarea></th>
     ...
     <tr>
                ...
                <tbody>
                    ...
                    <th><input type="text" name="meta3" value = "<%=rs.getString("meta3")%>" size="40" required></th>
           </tr>
        <tr>
            <td>Descripcion 3:</td>
            <th>  <textarea style="font-size:15px" rows="5" cols="43" type="text"  name="descripcion3"required ><%=rs.getString("descripcion3")%></textarea></th>
            <th>
