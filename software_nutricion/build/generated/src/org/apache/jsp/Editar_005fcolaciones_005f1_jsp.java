...
public final class Editar_005fcolaciones_005f1_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String np= request.getParameter("np");
    ...
    //Conexcion a la base de datos
        ...
        PreparedStatement col;
        ResultSet colacion;
      col=conexion.prepareStatement("SELECT id,nombre_platillo as np,ingredientes,tiempo_preparacion,instrucciones,calorias,estatus,imagen FROM software_nutricion.\"Recetas\" WHERE nombre_platillo='"+np+"'"); 
        
        colacion=col.executeQuery();
      ...
      out.print(colacion.getString("imagen"));
