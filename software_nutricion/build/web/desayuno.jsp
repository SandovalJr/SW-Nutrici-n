<%-- 
    Document   : desayuno
    Created on : 28/06/2019, 07:01:17 PM
    Author     : 52449
--%>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
   ...
   <title>DESAYUNOS RECETAS</title> <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
</head>
...
<% 
    //Conexcion a la base de datos
        ...
        PreparedStatement dd;
        ResultSet d;
      dd=conexion.prepareStatement("SELECT id,nombre_platillo as np,ingredientes,tiempo_preparacion,instrucciones,calorias,estatus FROM software_nutricion.\"Recetas\" WHERE estatus = 'desayuno'"); 
    ...
    <center>
        <div class="addthis_toolbox addthis_32x32_style addthis_default_style"><b><h1>DESAYUNOS</h1></b></div>
                 ...
                 <th style="background-color:#FFFF00"> <h3>estatus</h3></th>
                    ...
                    <tr>
                        ...
                        <th class="text-center"><%=d.getInt("id") %></th>
                         <th class="text-center"><%=d.getString("np") %></th>
                        <th class="text-center"><%=d.getString("ingredientes") %></th>
                        <th class="text-center"><%=d.getString("tiempo_preparacion") %></th>
                        <th class="text-center"><%=d.getString("instrucciones") %></th>
                        <th class="text-center"><%=d.getString("calorias") %></th>
                        <th class="text-center"><%=d.getString("estatus") %></th>
  <td>
                           
    <a href="eliminar_receta.jsp?id=<%=d.getInt("id") %>"><img src="boton-x.png"></a>      
    <a href="Editar_desayuno_1.jsp?np=<%=d.getString("np")%>" ><img src="editar2.png"></a>
