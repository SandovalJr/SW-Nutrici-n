...
<form action="DIETA" method="POST">
                ...
                <tbody>
                    <tr>
                        <td>Desayuno</td>
                         ...
                         <td><select name="desayuno1" required >
  ...
  <td>Desayuno</td> <!-- MENU 3 -->
                 <td><select name="desayuno3" required >
       ...
       rs=ps.executeQuery();  
        ...
        <tr>
            <td>Bebida</td>
                         ...
                         <td><select name="bebida1" required >
        ...
        while(rs.next()){
            out.println("<option value='"+rs.getString("nombre_platillo")+"'>"+rs.getString("nombre_platillo")+"</option>");
                    ...
                    <td>Bebida</td>
                         ...
                         <td><select name="bebida3" required >
        ...
        while(rs.next()){
            out.println("<option value='"+rs.getString("nombre_platillo")+"'>"+rs.getString("nombre_platillo")+"</option>");
                    ...
                    <tr>
                        ...
                        <td><select name="comida1" required  >
        ...
        while(rs.next()){
            out.println("<option value='"+rs.getString("nombre_platillo")+"'>"+rs.getString("nombre_platillo")+"</option>");
                    ...
                    %>   </option>    </td>
                        ...
                        <td><select name="comida3" required >
            ...
            out.println("<option value='"+rs.getString("nombre_platillo")+"'>"+rs.getString("nombre_platillo")+"</option>");
                    ...
                    <tr>
                       <td>Bebida</td>
                         ...
                         <td><select name="bebida11" required >
        ...
        while(rs.next()){
            out.println("<option value='"+rs.getString("nombre_platillo")+"'>"+rs.getString("nombre_platillo")+"</option>");
                    ...
                    <td>Bebida</td>
                         ...
                         <td><select name="bebida33" required >
        ...
        while(rs.next()){
            out.println("<option value='"+rs.getString("nombre_platillo")+"'>"+rs.getString("nombre_platillo")+"</option>");
                    ...
                    <tr>
                         ...
                         <td><select name="bebida111" required >
        ...
        while(rs.next()){
            out.println("<option value='"+rs.getString("nombre_platillo")+"'>"+rs.getString("nombre_platillo")+"</option>");
                    ...
                    <td>Bebida</td>
                         ...
                         <td><select name="bebida333" required >
            ...
            out.println("<option value='"+rs.getString("nombre_platillo")+"'>"+rs.getString("nombre_platillo")+"</option>");
                    ...
                    %>   </option> 
                         ...
                         <td>Colacion</td> <!--COLACION 1 -->
                                 <td><select name="colacion1" required >
            ...
            out.println("<option value='"+rs.getString("nombre_platillo")+"'>"+rs.getString("nombre_platillo")+"</option>");
                    ...
                    %>   </option>    </td>
                         ...
                         <td>Colacion</td> <!--COLACION 3 -->
                          <td><select name="colacion3" required >
                ...
                <tbody>
                    <tr>
                        <td>Desayuno</td> <!-- MENU 2 -->
                          <td><select name="desayuno2" required >
...
<td>Desayuno</td> <!-- MENU 4-->
   <td><select name="desayuno4" required >
       ...
       rs=ps.executeQuery();  
        ...
        while(rs.next()){
            ...
            <td>Bebida</td>
                         ...
                         <td><select name="bebida2" required >
        ...
        while(rs.next()){
            out.println("<option value='"+rs.getString("nombre_platillo")+"'>"+rs.getString("nombre_platillo")+"</option>");
                    ...
                    <td>Bebida</td>
                         ...
                         <td><select name="bebida4" required >
        ...
        while(rs.next()){
            out.println("<option value='"+rs.getString("nombre_platillo")+"'>"+rs.getString("nombre_platillo")+"</option>");
                    ...
                    <tr>
                       ...
                       <td><select name="comida2" required >
        ...
        while(rs.next()){
            out.println("<option value='"+rs.getString("nombre_platillo")+"'>"+rs.getString("nombre_platillo")+"</option>");
                    ...
                    %>   </option>    </td>
                       ...
                       <td><select name="comida4" required >
       ...
       rs=ps.executeQuery();  
        ...
        while(rs.next()){
            ...
            <td>Bebida</td>
                         ...
                         <td><select name="bebida22" required >
        ...
        while(rs.next()){
            out.println("<option value='"+rs.getString("nombre_platillo")+"'>"+rs.getString("nombre_platillo")+"</option>");
                    ...
                    <td>Bebida</td>
                         ...
                         <td><select name="bebida44" required >
       ...
       rs=ps.executeQuery();  
        ...
        while(rs.next()){
            ...
            <td>Bebida</td>
                         ...
                         <td><select name="bebida222" required >
        ...
        while(rs.next()){
            out.println("<option value='"+rs.getString("nombre_platillo")+"'>"+rs.getString("nombre_platillo")+"</option>");
                    ...
                    <td>Bebida</td>
                         ...
                         <td><select name="bebida444" required >
            ...
            out.println("<option value='"+rs.getString("nombre_platillo")+"'>"+rs.getString("nombre_platillo")+"</option>");
             ...
             <tr>
                         <td>Colacion</td> <!-- COLACION 2-->
                          <td><select name="colacion2"required >
        ...
        while(rs.next()){
            out.println("<option value='"+rs.getString("nombre_platillo")+"'>"+rs.getString("nombre_platillo")+"</option>");
                    ...
                    %>   </option>    </td>
                          ...
                          <td><select name="colacion4" required >
    ...
    <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <td>Desayuno</td> <!-- menu5-->
                          <td><select name="desayuno5" required >
       ...
       rs=ps.executeQuery();  
        ...
        while(rs.next()){
            ...
            <td>Bebida</td>
                         ...
                         <td><select name="bebida5" required >
        ...
        while(rs.next()){
            out.println("<option value='"+rs.getString("nombre_platillo")+"'>"+rs.getString("nombre_platillo")+"</option>");
                    ...
                    %>   </option> 
                       ...
                       <td><select name="comida5" required >
       ...
       rs=ps.executeQuery();  
        ...
        while(rs.next()){
            ...
            <td>Bebida</td>
                         ...
                         <td><select name="bebida55" required >
       ...
       rs=ps.executeQuery();  
        ...
        while(rs.next()){
            ...
            <td>Bebida</td>
                         ...
                         <td><select name="bebida555"  required>
        ...
        while(rs.next()){
            out.println("<option value='"+rs.getString("nombre_platillo")+"'>"+rs.getString("nombre_platillo")+"</option>");
                    ...
                    %>   </option> 
                         ...
                         <td><select name="colacion5" required >
       ...
       rs=ps.executeQuery();  
        ...
        <br> <br> <br> <br><br> <br> <br> <br>
            ...
            <div style="position: absolute; left: 65%" >
                <button style='width:110px; height:95px' class="login100-form-btn"> <img src="archivo.png"> REGISTRAR</button>
            </div>
