...
<% 
    ...
    <div class="container tabla">
        <div style="position: absolute; left: 35%">
                            <div class="addthis_toolbox addthis_32x32_style addthis_default_style"><b><h1>Selecciona Paciente Para Enviar Mensaje </h1></b></div>
        </div>
        <br><br><br>
         ...
         <tr>
             ...
             <th style="background-color:#FFFF00">  </th></tr>
                    ...
                    <td>
                        ...
                        <a href="Mensaje_Formulario_P.jsp?user=<%=rs.getString("user")%>&user_name=<%=user_name%>"> <img src="responder.png">  </a> 
                   ...
                   <br>  <br>
                    ...
                    <br>
                                       ...
                                       <div style="position: absolute; left: -4%"><img src="mono.png" width="500" height="300" alt=""/></div>
