<%-- 
    Document   : Editar_colaciones_1
    Created on : 7/07/2019, 12:38:01 PM
    Author     : 52449
--%>
...
<% 
    ...
    <center>
        <div class="addthis_toolbox addthis_32x32_style addthis_default_style"><b><h1>EDITAR COLACIONES</h1></b></div>
    ...
    <table   class="table table-bordered" >        
                 ...
                 <th style="background-color:#FFFF00"> <h3>estatus</h3></th>
                    ...
                    <tr >
                        ...
                        <th class="text-center"><h3><%=desa.getInt("id") %></h3></th>
               <th> <input style="font-size:15px" type="text"  name="np" value = "<%=desa.getString("np")%>" size="20" ></th>
               <th>  <textarea style="font-size:15px" rows="20" cols="20" type="text"  name="ingredientes" ><%=desa.getString("ingredientes")%></textarea></th>
               <th> <input style="font-size:15px" type="text"  name="tiempo_preparacion" value = "<%=desa.getString("tiempo_preparacion")%>" size="12" ></th>
               <th>  <textarea style="font-size:15px" rows="20" cols="25" type="text"  name="instrucciones" ><%=desa.getString("instrucciones")%></textarea></th>
               <th> <input style="font-size:15px" type="text"  name="calorias" value = "<%=desa.getString("calorias")%>" size="15" ></th>
                  <td ><select style="font-size:15px" name="estatus">
                    <option><%=desa.getString("estatus") %></option>
