...
<ul>
  ...
  <% 
    ...
    %>
        ...
        <br><br>
        <center>
<form action="Mensaje_Nutriologo" method="POST" class="form_contact">
...
%>
 <input type="text" name="fecha" readonly="" value = "<%=fech%>" size="12" required>
</div> 
                            </th>
               
                <tr>
                    <th >Tu Usuario : </th>
                    <th><input type="text" name="user_name_envia" readonly="" value = "Nutriologa" size="40" required></th>
                </tr>
                <tr>
                    <th>Para :</th>
                       <th><input type="text" name="user_name_recibe" readonly="" value = "<%= user%>" size="" required></th>
