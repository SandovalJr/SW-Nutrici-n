<%-- 
    Document   : Dieta_Actualizada_Con_Exito
    Created on : 15/07/2019, 12:02:10 PM
    Author     : 52449
--%>
...
<ul>
   ...
   <li class='active has-sub'><a href='http://localhost:8080/software_nutricion/Todas_Las_Recetas.jsp'><span>Recetas</span></a>
      <ul>
   ...
   </li>    <li><a href='http://localhost:8080/software_nutricion/dietas.jsp'><span>Dietas</span></a></li>
...
<script>
    swal({
  title: "Dieta Actualizada Con Exito",
  text: "Presiona el boton para continuar",
  imageUrl:"actualizado.png",
  button: "OK",
});
 </script>
