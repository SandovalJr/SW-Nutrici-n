...
<% 
    ...
    %>
                ...
                <%    
                       ...
                       int ide;
        ResultSet d;
    dieta=conexion.prepareStatement("SELECT id,user_name_envia as user,user_name_recibe,asunto,mensaje,estatus,fecha  FROM software_nutricion.\"Mensajes\" WHERE estatus ='No Leido' and user_name_recibe ='Nutriologa'"); 
                ...
                <th style="background-color:#FFFF00"> <h3></h3></th>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="Mensaje_Leido_Nutriologo.jsp?user=<%=d.getString("user")%>&user_name=<%=user_name%>&id=<%=d.getInt("id")%>"> <img src="visto.png">  </a> 
