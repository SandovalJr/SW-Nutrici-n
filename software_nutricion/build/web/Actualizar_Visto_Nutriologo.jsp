...
<% 
    ...
    %>
                ...
                <%    
                       ...
                       int ide;
        ResultSet d;
    dieta=conexion.prepareStatement("SELECT id,user_name_envia,user_name_recibe,asunto,mensaje,estatus,fecha  FROM software_nutricion.\"Mensajes\" WHERE estatus ='No Leido' and user_name_recibe ='Nutriologa'"); 
    ...
    <div class="container tabla">
        <div style="position: static; left: 5%">
                <div class="addthis_toolbox addthis_32x32_style addthis_default_style"><b><h1>Mensajes Recibidos </h1></b></div>
                    ...
                    <tr>
                        ...
                        <td>
                         ...
                         <a href="Eliminar_Mensaje_Nutriologo.jsp?id=<%=d.getInt("id")%>" ><img src="boton-x.png"></a>            
                          <form action="Update_Marcar_Leido_Nutriologo" method="POST">
  </form>
                         <a href="Actualizar_Visto_Nutriologo.jsp?id=<%=d.getInt("id")%>"><img src="visto.png"></a>
                                                  <a href="Editar_cena.jsp?np=<%=d.getString("user_name_envia")%>"><img src="responder.png"></a>
